...
# Export plot
ggsave(g, filename=file.path(plotdir, "FigSX_fixed_effects_model_param_hists.png"), 
...
# Export plot
ggsave(g, filename=file.path(plotdir, "FigSX_random_effects_model_param_hists.png"), 
       width=6.5, height=5, units="in", dpi=600)
