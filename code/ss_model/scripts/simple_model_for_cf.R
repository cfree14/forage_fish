...
# Directories
datadir <- "code/ss_model/data"
codedir <- "code/ss_model/scripts"

# Source helper functions
source(file.path(codedir, "simple processing_for_cf.R"))
...
cat("
  ...
  ",file=file.path(codedir, "ssmlinear.txt"))
...
inputlist <- prepare_data(spx, fixed_param_list, covariate_list, datadir, use_en_thresh, en_thresh, simulation_options)
